...
(function () {
  ...
  const T = {
    en: {
      ...
      'about.title': 'About',
      'about.lead': 'Product Manager with <span class="em">4 years</span> of cross-functional experience across Web3/DeFi and B2C software, with a profound understanding of the full product development life cycle. Proven at shipping products end to end and engineering AI agents into production workflows. Skilled in Agile and grounded in a user-centric, data-informed mindset.',
      ...
      'work.title': 'Work',
      'work.lead': 'Product delivery across blockchain and live streaming.',
      'role.pm': 'Product Manager', 'role.epa': 'Product Manager Assistant',
      ...
      'b.typus.lead': 'End-to-end product owner for Sui on-chain derivatives at Sui\'s #1 DeFi option-vault protocol, driving roadmap and the product-development process → <span class="m">30+ features and iterations</span>',
      'b.typus.perp': 'Built a new leveraged-trading product (perpetual futures) from 0→1, scaling it to <span class="m">~$87M trading volume in its first quarter (+383% MoM)</span> with <span class="m">TLP (liquidity pool) TVL +217%</span>',
      'b.typus.rebrand': 'Orchestrated a major brand rebrand with the product-operations team, reshaping the site experience → <span class="m">unique site visitors +15%</span>',
      'b.typus.metrics': 'Launched SAFU, a principal-protected structured product (deposits protected while earning returns) → <span class="m">platform MAU growth of ~20×</span>',
      'b.17live.lead1': 'Owned cross-region product experience focused on lifting platform user satisfaction, collaborating with TW / JP / SEA regional teams and aligning up to C-level',
      'b.17live.lead2': 'Focused on enhancing the user experience of viewing livestream content, from user interviews and competitor analysis to MVP',
      'b.17live.clip': 'Built short-form livestream clips (create and share highlights) → <span class="m">content creation +10%</span>, top homepage click-through and share rates',
      ...
      'b.17live.avatar': 'Optimized the V-Liver virtual avatar with the livestream-effects team → <span class="m">effective view time +10%</span>',
      'b.17live.roadmap': 'Turned cross-region user-feedback and complaint data into prioritized product requirements → <span class="m">retention +10%</span>, <span class="m">positive feedback +30%</span>',
      'b.eslite1': 'Coordinated <span class="m">20+ on-site events</span> across suppliers, staff and participants',
      'b.eslite2': 'Managed venue layout, timelines and resources, with document and data support',
